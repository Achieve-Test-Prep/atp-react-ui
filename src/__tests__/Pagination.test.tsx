...
describe('Pagination', () => {
  ...
  it('should render a list taking into account resultsPerPage', () => {
    const onChange = () => {};
    const expected = 6;
    const wrapper = mount(<Pagination totalResults={30} resultsPerPage={5} label="Navigation" onChange={onChange} />);
  ...
  it('should not call click handler on next button if last page', () => {
    const onChange = jest.fn();
    const wrapper = mount(<Pagination totalResults={10} resultsPerPage={5} label="Navigation" onChange={onChange} />);
  ...
  it('should render two "..." in the middle of a big list', () => {
    const onChange = () => {};
    const wrapper = mount(<Pagination totalResults={50} resultsPerPage={5} label="Navigation" onChange={onChange} />);
