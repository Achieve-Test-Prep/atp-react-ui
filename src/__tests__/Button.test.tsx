...
describe('Sizes', () => {
  it('should render a larger button', () => {
    ...
    const wrapper = mount(<Button aria-label="test" size="lg" />);
  ...
  it('should render a regular button', () => {
    const expected = 'px-4 py-2 rounded-lg text-sm';
    const wrapper = mount(<Button aria-label="test" size="base" />);
  ...
  it('should render a small button', () => {
    ...
    const wrapper = mount(<Button aria-label="test" size="sm" />);
...
describe('Outline Button', () => {
  it('should contain outline base classes', () => {
    ...
    const wrapper = mount(<Button aria-label="test" as="outline" />);
  ...
  it('should contain outline disabled classes', () => {
    ...
    const wrapper = mount(<Button aria-label="test" as="outline" disabled />);
...
describe('Link Button', () => {
  it('should contain link base classes', () => {
    ...
    const wrapper = mount(<Button aria-label="test" as="link" />);
  ...
  it('should contain link disabled classes', () => {
    const expected = 'opacity-50 cursor-not-allowed';
    const wrapper = mount(<Button aria-label="test" as="link" disabled />);
...
describe('DropdownItem Button', () => {
  it('should contain DropdowItem button classes', () => {
    ...
    const wrapper = mount(<Button aria-label="test" as="__dropdownItem" />);
...
describe('Icon', () => {
  ...
  it('should contain small sized button icon classes', () => {
    ...
    const wrapper = mount(<Button aria-label="test" size="sm" icon={HeartIcon} />);
  ...
  it('should contain large sized button icon classes', () => {
    ...
    const expectedSvg = 'h-5 w-5';
    const wrapper = mount(<Button aria-label="test" size="lg" icon={HeartIcon} />);
