...
describe('Badge', () => {
  ...
  it('should render with success styles', () => {
    const expected = 'text-green-700 bg-green-100 tb:bg-green-700 tb:text-green-100';
  ...
  it('should render with error styles', () => {
    const expected = 'text-red-700 bg-red-100 tb:text-red-100 tb:bg-red-700';
    const wrapper = mount(<Badge type="error" />);

    expect(wrapper.find('span').getDOMNode().getAttribute('class')).toContain(expected);
  });

  it('should render with warning styles', () => {
    const expected = 'text-orange-700 bg-orange-100 tb:text-white tb:bg-orange-600';
  ...
  it('should render with neutral styles', () => {
    const expected = 'text-gray-700 bg-gray-100 tb:text-gray-100 tb:bg-gray-700';
  ...
  it('should render with primary styles', () => {
    const expected = 'text-purple-700 bg-purple-100 tb:text-white tb:bg-purple-600';
