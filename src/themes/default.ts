...
export const defaultTheme = {
  ...
  // TableContainer
  tableContainer: {
    base: twSort`ring-opacity-5 w-full overflow-hidden rounded-lg ring-1 ring-black`,
  },
  // TableCell
  tableCell: {
  ...
  checkbox: {
    active: twSort`focus:border-primary focus:ring-primary-light focus:ring focus:ring-offset-0 focus:outline-none`,
    disabled: twSort`disabled:text-accent-disabled disabled:border-outline disabled:cursor-not-allowed disabled:bg-gray-50`,
  ...
  radio: {
    ...
    active: twSort`border-outline focus:border-primary focus:ring-primary-light focus:ring focus:ring-offset-0 focus:outline-none`,
